...
disabled = false, loading = false, center = false, iconPosition = "left", icon, style, type = "button", }, ref) => {
    return (react_1.default.createElement("button", { type: type, ref: ref, onClick: onClick, disabled: disabled || loading, className: (0, classnames_1.default)(Button_scss_1.default.button, Button_scss_1.default[color], iconPosition && Button_scss_1.default[iconPosition], center && Button_scss_1.default.center), style: style },
